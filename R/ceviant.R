#' This function produces output data based on the Convergence epidEmic Volatility Index As aN early-warning Tool (cEVI)
#'
...
#' @examples
#' data("Italy")
#' ceviant(new_cases=Italy$Cases, cum=FALSE, r_a=7, r=0.2, lag_max=30)
...
#'
#' @references
#' Pateras Konstantinos, Meletis Eleftherios, Matthew Denwood, Paolo Eusebi and Kostoulas Polychronis, The convergence epidemic index, an early warning tool for identifying waves in an epidemic, 2022


ceviant=function(new_cases, cum = FALSE, r_a=7, r=0.2, lag_max=30){
  #source("mova.r")
  #source("medvol.r")
  #source("evi.r")
  #source("evifcut.r")
